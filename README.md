<img src="https://pbs.twimg.com/media/D9RppM5WkAAdBIX?format=jpg&name=large" alt="Borderlands Banner" width="100%">

## Olá, eu sou a Andrea Sousa! 👋
...
* 🛠️ **Engenharia & Infraestrutura:** Construção de pipelines de dados estruturados (ETL/ELT), orquestração de fluxos e automações seguras em nuvem.
* 📊 **Modern Data Stack & DW:** Transformação de dados com dbt, modelagem dimensional (Star Schema) e gerenciamento de Data Warehouses modernos.
* 🧪 **Inteligência e Negócios:** Criação de dashboards táticos e estratégicos com regras complexas de negócios, métricas temporais avançadas e segurança a nível de linha (RLS).
...
* 🎮 Apaixonada pela cultura pop: do caos de *Borderlands* a maratonas de séries e universos expandidos.
* 🌌 Curiosa sobre astrologia, dinâmicas de comportamento humano e análise de padrões cotidianos.
* 🥊 Praticante de boxe e bike, entusiasta de uma boa pizza e escritora nas horas vagas.
* 🎙️ Fã de carteirinha da Christina Aguilera desde sempre.
